...
verified reversibly, and it can **create and delete** files in the root
— including **multi-cluster** files, allocating and linking the FAT
chain as it writes. It does not yet write subdirectories. 8.3 names only.
